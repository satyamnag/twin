...
bedrock_client = boto3.client(
    ...
    region_name=os.getenv("DEFAULT_AWS_REGION", "ap-south-1")
)
...
BEDROCK_MODEL_ID = os.getenv("BEDROCK_MODEL_ID", "arn:aws:bedrock:ap-south-1:748344702222:inference-profile/apac.amazon.nova-micro-v1:0")
